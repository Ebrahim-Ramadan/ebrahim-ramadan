...
export default async function Home() {
  ...
  <a href="https://drive.google.com/file/d/1sduRrtFNXgxUOVvvZvMY3IpTLaI4V6uc/view" target="_blank" className="flex flex-row items-center text-neutral-200 hover:text-neutral-400 hover:underline gap-2 group transition-all duration-200">
